...
# print(get_country_code([{"name":"Afghanistan","alpha3Code":"AFG"}], "Afghanistan"))


def get_country_code(country_name: str, get_list_of_countries):
...
print(get_country_code("Azerbaijan", get_countries))

def test_get_country_code():
    literally_anything = "Afghanistan"
    expected = "AFG"

    def mock_get_countries():
        return [{"name":"Afghanistan","alpha3Code":"AFG"}]

    result = get_country_code(literally_anything, mock_get_countries)
